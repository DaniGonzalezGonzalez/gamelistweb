...
import { addGameFicha } from './ByFichaUtils/addGameFicha'
...
export function PanelAddEstadoFicha({ juego, onAvanzar, onClose, onEstadoChange, textoBoton, id, titulo, tabla, onAdded, estadoActual, onPosition, platform, platformDefault }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
      <div ref={panelEstadoRef} className="scroll-container flex flex-col items-center p-6 text-gray-100 border-2 border-gray-300 rounded-lg shadow-lg bg-slate-950 max-h-[90vh] xl:h-96 xl:justify-evenly overflow-y-scroll w-5/6 sm:w-1/2 mt-14 sm:mt-0" onClick={(e) => e.stopPropagation()}>
        { onAdded && 
