...
export function OnlineExamplesGallery() {
  ...
  return (
    <div className="relative px-8 py-10 bg-black sm:pt-14 sm:pb-10 sm:px-16">
      ...
      <h2 className="relative z-20 pt-0 text-lg font-semibold text-white text-start sm:text-xl lg:pt-14">¿Cómo se ve la web?</h2>
      ...
      <div className="mt-5 sm:hidden">
        ...
        <p className="pt-8 text-xs text-justify">
          ...
          Encuéntralos y añádelos fácilmente en un amplio catálogo con múltiples plataformas, géneros, sagas y desarrolladoras.
        </p>
      </div>
      
      {/* Slider para PC */}
      <div className="hidden pt-5 sm:block">
        <h1 className="pb-5">Formato PC</h1>
        <Swiper
          spaceBetween={20}
          slidesPerView={2}
          pagination={{ clickable: true }}
