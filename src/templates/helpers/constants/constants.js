...
export const formatDate = (intDate) => {
    const year = Math.floor(intDate / 100); // Obtiene los primeros 4 dígitos
    const month = intDate % 100; // Obtiene los últimos 2 dígitos
    return `${month.toString().padStart(2, '0')}-${year}`; // Formatea como "MM-YYYY"
}
