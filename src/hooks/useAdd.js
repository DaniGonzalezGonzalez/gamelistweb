...
export function useAdd(tituloRef, tipoContenidoRef) {
    ...
    const handleUpload = async (e) => {
        try {
            ...
            // const url2 = await uploadPlatformFile(file2, tipoContenido, `${nombrePlataforma}_file2`);
            obj.url = [
                url1, 
                // url2
            ];
    ...
    // const uploadPlatformFile = async (file, tipoContenido, nombre) => {
    //     console.log('Este es el nombre del bucket que le paso', nombre)
    //     const bucketName = 'platformImages'; // Asegúrate de definir correctamente el nombre del bucket aquí
