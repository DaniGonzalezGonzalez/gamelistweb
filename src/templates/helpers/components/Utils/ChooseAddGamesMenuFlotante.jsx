        ...
        `}>
          {platformItems.map((item) => (
            ...
            <div className={`flex items-center cursor-pointer`}>
              ...
              ${(item.name === 'Xbox 360' || item.name === 'PC') && 'p-2 sm:p-1.5 lg:p-3'}
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center p-5 transition-transform transform rounded-lg shadow-2xl lg:p-8 sm:p-4 bg-slate-800">
        {/* <h2 className="mb-6 text-2xl font-bold text-white">Selecciona una opción</h2> */}
            ...
            <div className="flex flex-col items-center justify-center gap-3 p-4 text-center text-white transition duration-500 shadow-md cursor-pointer rounded-3xl w-60 h-44 sm:h-36 lg:h-80 sm:w-48 lg:w-80 bg-slate-700 hover:bg-slate-600">
             ...
             <div className="flex flex-col items-center justify-center text-xs lg:text-sm gap-7 lg:gap-10 sm:gap-5">
                ...
                <div className="grid grid-cols-3 gap-3 sm:gap-2">
                  ...
                  <button onClick={() => handlePlatformClick('Retro')} title="Consola retro" className="flex items-center justify-center"><div className="flex flex-col items-center justify-center h-10 p-1 font-bold text-black transition duration-500 shadow lg:h-10 lg:w-14 rounded-xl bg-slate-200 shadow-black hover:bg-red-500 sm:h-8 sm:w-12 w-14"><ControllerIcon color={'black'}/></div></button>
                </div>
              </div>}
        ...
        <button 
          ...
          className="w-32 p-2 mt-6 text-white transition-shadow rounded-lg shadow-md bg-slate-600 hover:bg-slate-500 hover:shadow-lg"
        >
          Cerrar
        </button>
      </div>
