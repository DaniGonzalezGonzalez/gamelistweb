...
//     >
//         <Link to="/admin-add-game-to-list-by-platform/PC">
//             <div className="flex items-center justify-start w-full gap-1 p-1 text-xs sm:text-[10px] lg:text-xs transition duration-300 rounded-lg hover:bg-slate-800">PC</div>
//         </Link>
