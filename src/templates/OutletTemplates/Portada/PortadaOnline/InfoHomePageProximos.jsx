...
export function InfoHomePageProximos() {
    ...
    const visibleItems = useVisibilityObserver(".observed-item", threshold, ["proximos-block"]);
    ...
    return (
        <>
            <div data-id="proximos-block" className={`observed-item relative px-2 pb-8 sm:py-4 sm:px-3 lg:px-8 sm:pl-20 lg:pl-28 lg:pr-8 transition duration-1000 ease-out ${visibleItems["proximos-block"] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
