...
export function InfoHomePageGamesCategoriesOffline() {
  ...
  return (
    <div className="relative px-8 pt-32 pb-0 bg-black sm:pt-14 sm:pb-10 sm:px-16">
      ...
      <h2 className="relative z-20 flex w-full gap-4 text-lg font-semibold pt-14 lg:pt-60 text-start sm:text-xl">Categorías variadas</h2>
      <div className="flex justify-center gap-5 py-5 sm:py-10 lg:gap-20 sm:gap-10">
        <div className="w-full" >
          <button className="relative z-20 flex flex-col items-center justify-center w-full" onClick={scrollToTop}><img className="object-cover w-full h-40 transition duration-500 rounded-lg sm:h-40 lg:h-96 hover:opacity-75" src={selectedImage} alt='Cargando...' />
      ...
      <div className="flex justify-center gap-5 pt-2 lg:pt-10 lg:gap-20 sm:gap-10">
        <div className="w-1/2">
          <button className="relative z-20 flex flex-col items-center justify-center w-full" onClick={scrollToTop}><img className="object-cover w-full h-40 transition duration-500 rounded-lg sm:h-40 lg:h-96 hover:opacity-75" src={selectedImage2} alt='Cargando...' />
        ...
        <div className="w-1/2">
          <button className="relative z-20 flex flex-col items-center justify-center w-full" onClick={scrollToTop}><img className="object-cover w-full h-40 transition duration-500 rounded-lg sm:h-40 lg:h-96 hover:opacity-75" src={selectedImage3} alt='Cargando...' />
